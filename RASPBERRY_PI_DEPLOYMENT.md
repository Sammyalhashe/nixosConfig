...
| :--- | :--- | :--- | :--- |
| **pi1** | `11.125.37.99` | Network/Privacy | AdGuard Home, WireGuard VPN |
...
We use **SOPS** with **Age** encryption to store secrets like VPN keys and Database passwords.
...
| **WireGuard** | pi1 | UDP `51820` | Configured in `hosts/pi1` |
